                    ...
                    <div class="footer-item popular-posts">
                        ...
                        <div class="media">
                            <div class="media-left">
                                <img class="media-object" src="{{ asset('user/img/properties/small-properties-1.jpg') }}" alt="small-properties-1">
                            </div>
                        ...
                        <div class="media">
                            <div class="media-left">
                                <img class="media-object" src="{{ asset('user/img/properties/small-properties-2.jpg') }}" alt="small-properties-2">
                            </div>
                            <div class="media-body">
                                <h3 class="media-heading">
                        ...
                        <div class="media">
                            <div class="media-left">
                                <img class="media-object" src="{{ asset('user/img/properties/small-properties-3.jpg') }}" alt="small-properties-3">
                            </div>
                            <div class="media-body">
                                <h3 class="media-heading">
...
<script src="{{ asset('user/js/bootstrap-submenu.js') }}"></script>
<script src="{{ asset('user/js/rangeslider.js') }}"></script>
<script src="{{ asset('user/js/jquery.mb.YTPlayer.js') }}"></script>
...
<script src="{{ asset('user/js/leaflet.js') }}"></script>
<script src="{{ asset('user/js/leaflet-providers.js') }}"></script>
<script src="{{ asset('user/js/leaflet.markercluster.js') }}"></script>
<script src="{{ asset('user/js/dropzone.js') }}"></script>
<script src="{{ asset('user/js/jquery.filterizr.js') }}"></script>
